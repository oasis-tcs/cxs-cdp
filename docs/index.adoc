...
TODO: write an introduction to optimization and recommendations

TODO : cleanup section structure
...
[source,graphql]
----
include::{sourcedir}/schemas/optimizations.js[lines=12..17]
----
...
Name::  Name of algorithm, examples may be similarity, bought-Together, bought-byOthers, viewed-byOthers, trending, related
...
TODO : Write an introduction about matching, maybe talk about how it can be used in a CMS example

This is an example of matching a profile with a real-time filter :
