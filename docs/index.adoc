...
==== EmptyTypeWorkAround
TODO: GraphQL types cannot be empty,   is this required by actual implementations??
...
* *id* The "system" source ID is reserved for internal use by CDP server (TODO call this CDP instead?).
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=41..53]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=55..66]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=69..72]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=74..78]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=80..84]
----
...
Collectively, all Profile properties define the schema of properties that can be used by any profile in the Customer Data Platform.
...
Any data imported to the system must be mapped to a corresponding Profile properties.
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=64..64]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=68..69]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/consents.js[lines=29..32]
----
