...
[source,graphql]
----
include::{sourcedir}/schemas/properties/enum.js[lines=5..12]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/properties/enum.js[lines=14..21]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/filters.js[lines=27..37]
----
