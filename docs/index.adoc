...
[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=5..8]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=10..13]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=28..41]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=5..10]
----

Below are the the generated types of the sample ProfileProperties listed above

[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=12..40]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/propertytypes.js[lines=5..12]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/propertytypes.js[lines=17..26]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/booleanpropertytypes.js[lines=2..10]
----

==== CDP_BooleanPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/booleanpropertytypes.js[lines=12..20]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/datepropertytypes.js[lines=5..13]
----

==== CDP_DatePropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/datepropertytypes.js[lines=15..23]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/floatpropertytypes.js[lines=2..12]
----

==== CDP_FloatPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/floatpropertytypes.js[lines=14..24]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/geopointpropertytypes.js[lines=5..13]
----

==== CDP_GeoPointPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/geopointpropertytypes.js[lines=15..23]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/identifierpropertytypes.js[lines=5..14]
----

==== CDP_IdentifierPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/identifierpropertytypes.js[lines=16..25]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/intpropertytypes.js[lines=2..12]
----

==== CDP_IntPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/intpropertytypes.js[lines=14..24]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/stringpropertytypes.js[lines=2..11]
----

==== CDP_StringPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/stringpropertytypes.js[lines=13..22]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/setpropertytypes.js[lines=5..13]
----

==== CDP_SetPropertyTypeInput

[source,graphql]
----
include::{sourcedir}/schemas/setpropertytypes.js[lines=15..23]
----
...
Profile merges are optional in the CXS specification. They may be supported by using a property defined as an identifier as a merge key (multiple merge keys may of course exist) to merge multiple profiles. The resulting merged profile MUST contain all the source profile IDs of the merged profiles as well as the merged profile data. The original profiles that were merged may be flagged or deleted, this is implementation specific.

[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=2..9]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=11..17]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/events.js[lines=79..80]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/events.js[lines=84..84]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=35..38]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=40..44]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=46..49]
----

==== CDP_UpdateConsentInput

[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=52..54]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=57..60]
----

==== CDP_UpdateProfileInput

[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=63..66]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=102..102]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=106..107]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/lists.js[lines=17..18]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/lists.js[lines=22..25]
----
