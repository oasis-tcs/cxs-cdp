...
----
git clone https://github.com/oasis-tcs/cxs-cdp -c 1.0.0
cd server/
npm install
npm start
----
...
TODO: READ THIS SERGE
They may be supported by using a property defined as an identifier as a merge key.
Multiple merge keys may of course exist to merge multiple profiles.
