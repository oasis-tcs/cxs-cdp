...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=75..77]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=81..83]
----
...
TODO: Is this actually available? How do we create new properties with it?
