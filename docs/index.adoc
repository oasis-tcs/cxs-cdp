...
==== ARE THESE EVENT TYPES?

TODO, is this correctly placed?

[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=42..64]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=97..97]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=101..102]
----
