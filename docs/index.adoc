...
=== GraphQL
The API itself is strongly typed, but consider specific security measurements related to GraphQL, such as input validation.
For more information: https://facebook.github.io/graphql/June2018/#sec-Validation
