...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=42..44]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=48..50]
----
...
A ProfileProperties is technically a PropertyType, where the name must be unique for all ProfileProperties.
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=42..45]
----
...
[source,graphql]
----
include::{sourcedir}/schemas/eventtypes.js[lines=17..20]
----
