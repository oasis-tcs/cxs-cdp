...
TODO: Are we missing a way to specify profileProperties??

We update profiles always through events.
...
==== Sample ProfilePropertyTypes

[source,graphql]
----
include::{sourcedir}/schemas/profileproperties.js[lines=19..41]
----
