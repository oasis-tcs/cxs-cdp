...
SAMPLE: An implementation conforms to this speciﬁcation if it satisﬁes all of the MUST or REQUIRED level requirements deﬁned within this speciﬁcation.
////

The specification GraphQL API provides the most basic functionality that is expected of a conformant CDP server.
A CDP implementation conformant to this specification SHALL meet all the conditions documented in the <<API>> section.

Any parts of the specification stated as OPTIONAL or RECOMMENDED TODO conformance.
