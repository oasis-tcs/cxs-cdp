...
[horizontal]
::
https://docs.oasis-open.org/cxs/cdp/v1.0/cs01/cdp-v1.0-cs01.adoc (Authoritative) +
https://docs.oasis-open.org/cxs/cdp/v1.0/cs01/cdp-v1.0-cs01.html +
https://docs.oasis-open.org/cxs/cdp/v1.0/cs01/cdp-v1.0-cs01.pdf
...
*CDP-v1.0*
+
_Customer Data Platform Version 1.0_. Edited by Thomas Lund Sigdestad and Serge Huber. 04 October 2019.
...
[source,graphql]
----
include::{sourcedir}/schemas/profiles.js[lines=86..88]
----
