...
Collectively, all ProfilePropertiess defines the schema of properties that can be used by any profile in the Customer Data Platform.
...
A ProfileProperties is technically a PropertyType, where the name must be unique for all ProfilePropertiess.
