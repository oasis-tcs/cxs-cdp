...
[#RFC3986]
*[RFC3986]* T. Berners-Lee, "Uniform Resource Identifier (URI): Generic Syntax", RFC 8174, Jan, 2005, https://tools.ietf.org/html/rfc3986
...
- <<CDP_ProfileUpdateEvent,Updating profile properties>>, used to update a profile properties (built-in)
- <<CDP_SessionEvent,Session>> start/paused/resumed/stopped (built-in)
- <<CDP_ConsentUpdateEvent,Updating consent>>, used to update a profile's consents ( see http://ec.europa.eu/ipg/basics/legal/cookies/index_en.htm ) (built-in)
- <<CDP_ListsUpdateEvent,Opt-in / opt-out>> of a list (built-in)
